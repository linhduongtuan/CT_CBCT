...
"""
Phân tích và so sánh file CT và CBCT - Phiên bản đã sửa lỗi warnings
"""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Phân tích và so sánh ảnh CT và CBCT trong thư mục DICOM',
